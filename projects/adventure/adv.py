...
while len(visited_set) < 500:
    ...
    if "n" in all_current_exits and all_current_exits["n"] == "?":
        ...
        if room_to_the_north not in traversalRooms:
            room_to_the_north_exits = {}
            for exit in player.currentRoom.getExits():
                room_to_the_north_exits[exit] = "?"
            room_to_the_north_exits["s"] = current_room
            traversalRooms[room_to_the_north] = room_to_the_north_exits
        else:
        ...
        if room_to_the_south not in traversalRooms:
            room_to_the_south_exits = {}
            for exit in player.currentRoom.getExits():
                room_to_the_south_exits[exit] = "?"
            room_to_the_south_exits["n"] = current_room
            traversalRooms[room_to_the_south] = room_to_the_south_exits
        else:
            # else if it does exist already
...
def curr_room_command():
    print(player.currentRoom.id, 'this is the id of the current room')
...
one_line_commands = {}
one_line_commands['exit'] = exit_command
one_line_commands['current'] = curr_room_command
one_line_commands['getexits'] = get_exits
one_line_commands['visited'] = get_visited_rooms
...
#     visited_rooms.add(player.currentRoom)
#     if cmds[0] in ['n','s','w','e']:
#         player.travel(cmds[0], True)
#     elif cmds[0] in one_line_commands:
#         one_line_commands[cmds[0]]()
#     else:
